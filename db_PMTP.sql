...
/****** Tabloları ve Anahtar Alanları Oluşturma – UNIQUE DEFAULT ve PRIMARY KEYLER TABLOLARIN İÇİNDE BULUNUYOR. ******/
...
insert into tbl_Personeller(Pers_Adi,Pers_Soyadi,Pers_DTarihi,Pers_Ise_Giris_Tarihi,Pers_Isten_Cikis_Tarihi,Pers_Adresi,Pers_Ili,Pers_Kenti,Pers_Il_Kodu,Pers_Tel,Pers_Cep,Pers_Email,Bolum_ID,Pers_Maas,Pers_Komisyon_Yuzdesi,Cinsiyet_ID,Unvan_ID,Pers_SGK_No,Pers_TC_No,Pers_Aktif_Mi,Pers_Foto,Pers_CV,Pers_CV_File,Pers_CV_Web,Kaydeden,Kayit_Tarihi) values('Buse','Yılmaz','12.12.1999','03.12.2020','','Ferah Mah. Çamlıca','İstanbul','Üsküdar','34','78945612332','6851318321','buse@gmail.com','4','','','0','4','7867343455','23453786544','1','','','','','','')
...
insert into tbl_Kategoriler(Cinsiyet,Unvan,Kent_Adi,Il_Kodu,Il_Adi,Ulke,Ay_Adi,Kitap_Turu) values ('K','VT Yönetimi','Karamürsel','41','Kocaeli','Türkiye','Ocak','Bilişim')
insert into tbl_Kategoriler(Cinsiyet,Unvan,Kent_Adi,Il_Kodu,Il_Adi,Ulke,Ay_Adi,Kitap_Turu) values ('E','Satış Elemanı','Karamürsel','41','Kocaeli','Türkiye','Mart','Kentleşme')
insert into tbl_Kategoriler(Cinsiyet,Unvan,Kent_Adi,Il_Kodu,Il_Adi,Ulke,Ay_Adi,Kitap_Turu) values ('K','Pazarlamacı','Karamürsel','41','Kocaeli','Türkiye','Ekim','Bilim')
insert into tbl_Kategoriler(Cinsiyet,Unvan,Kent_Adi,Il_Kodu,Il_Adi,Ulke,Ay_Adi,Kitap_Turu) values ('K','Ofis Yöneticisi','Karamürsel','41','Kocaeli','Türkiye','Aralık','Öğretim')
insert into tbl_Kategoriler(Cinsiyet,Unvan,Kent_Adi,Il_Kodu,Il_Adi,Ulke,Ay_Adi,Kitap_Turu) values ('K','CIO','Derince','41','Kocaeli','Türkiye','Mayıs','Yönetim')
...
/****** ALTER TABLE ile FOREIGN KEYLERİ OLUŞTURMA ******/
